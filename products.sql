...
-- Thời gian đã tạo: Th10 14, 2018 lúc 07:11 PM
...
(1, 'SamSung Galaxy Note9', 'note9.png', 'Mang lại sự cải tiến đặc biệt trong cây bút S-Pen, siêu phẩm Samsung Galaxy Note 9 còn sở hữu dung lượng pin khủng lên tới 4.000 mAh cùng hiệu năng mạnh mẽ vượt bậc, xứng đáng là một trong những chiếc điện thoại cao cấp nhất của Samsung.', 4, 1, 21500000),
(2, 'SamSung galaxy j7', 'galaxyj7.png', 'Galaxy J7 Prime xứng đáng là cái tên hàng đầu trong danh sách chọn smartphone phổ thông của giới trẻ khi nhận được nhiều đánh giá tích cực về thiết kế, thời lượng pin lâu dài và camera chụp hình chất lượng tốt.', 4, 1, 500000),
(3, 'Apple iphone 5c', 'iphone5c.jpg', 'iPhone 5C được làm từ vật liệu polycarbonat chống trầy, bộ vỏ được gia công từ một khối nhựa duy nhất, tương tự iPhone 5S làm từ 1 khối nhôm duy nhất. Vì vậy, bạn sẽ khó có thể tìm ra bất kỳ khớp nối nào trên máy. Bên dưới bộ vỏ là một lớp kim loại nhằm mục đích giúp máy cứng cáp hơn và kiêm luôn chức năng của 1 chiếc anten thu phát sóng.', 1, 1, 1000000),
